...
newestComicListEntityFromJson(NewestComicListEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
...
newestComicListDataFromJson(NewestComicListData data, Map<String, dynamic> json) {
	...
	if (json['returnData'] != null) {
		data.returnData = new NewestComicListDataReturnData().fromJson(json['returnData']);
	}
	return data;
}
...
newestComicListDataReturnDataFromJson(NewestComicListDataReturnData data, Map<String, dynamic> json) {
	if (json['page'] != null) {
...
Map<String, dynamic> newestComicListDataReturnDataToJson(NewestComicListDataReturnData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
newestComicListDataReturnDataComicFromJson(NewestComicListDataReturnDataComic data, Map<String, dynamic> json) {
	if (json['author'] != null) {
...
Map<String, dynamic> newestComicListDataReturnDataComicToJson(NewestComicListDataReturnDataComic entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
