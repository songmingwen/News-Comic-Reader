...
class NewestComicListDataReturnData
    with JsonConvert<NewestComicListDataReturnData> {
  int page;
  bool hasMore;
  List<NewestComicListDataReturnDataComic> comics;
}

class NewestComicListDataReturnDataComic
    with JsonConvert<NewestComicListDataReturnDataComic> {
  String author;
  int comicId;
  String conTag;
  String cover;
