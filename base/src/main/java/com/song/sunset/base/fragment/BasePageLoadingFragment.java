 ...
 * @since 2020/12/16
 */
public abstract class BasePageLoadingFragment<T extends PageEntity> extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                BasePageLoadingFragment.this.onScrollStateChanged(recyclerView, newState);
            }

            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                BasePageLoadingFragment.this.onScrolled(recyclerView, dx, dy);
            }
        });
        ...
        mSwipeRefreshLayout.setOnLoadMoreListener(refreshlayout -> loadMore(mPaging));
    }
