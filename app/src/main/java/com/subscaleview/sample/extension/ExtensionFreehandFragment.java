...
import com.subscaleview.sample.extension.views.FreehandView;
...
public class ExtensionFreehandFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final FreehandView imageView = (FreehandView)rootView.findViewById(R.id.imageView);
        imageView.setImage(ImageSource.asset("squirrel.jpg"));
        rootView.findViewById(R.id.reset).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                imageView.reset();
            }
