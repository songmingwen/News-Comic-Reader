...
import com.song.game.wuxia.bean.character.CharacterList
import com.song.game.wuxia.bean.wuxue.Wuxue
import com.song.game.wuxia.bean.wuxue.WuxueList
import com.song.game.wuxia.utils.DamageUtil
...
import kotlinx.android.synthetic.main.activity_wuxia_battle.*
import java.lang.StringBuilder
import java.util.LinkedHashMap


@Route(path = "/song/wuxia/battle")
class WuXiaBattleActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_wuxia_battle)
                ...
                .map {
                    if (it) {
                        ...
                        if (DamageUtil.isHit(enemy, self, enemyWuxue)) {
                            ...
                            showMessage(getColorfulText(LinkedHashMap<String, String>().apply {
                                this["躲过了 ${enemy.name} 的攻击"] = "#9E9E9E"
                            }))
                        }
                    } else {
                        showMessage(getColorfulText(LinkedHashMap<String, String>().apply {
