package com.song.game.wuxia.bean.character;

import com.song.game.wuxia.bean.ability.Ability;
import com.song.game.wuxia.bean.attribute.Agility;
import com.song.game.wuxia.bean.attribute.PhysicalAttack;
import com.song.game.wuxia.bean.attribute.Attribute;
import com.song.game.wuxia.bean.attribute.PhysicalDefence;
import com.song.game.wuxia.bean.attribute.DodgeRate;
import com.song.game.wuxia.bean.attribute.Health;
import com.song.game.wuxia.bean.attribute.HitRate;
import com.song.game.wuxia.bean.attribute.PhysicalCriticalRate;
import com.song.game.wuxia.bean.attribute.Spells;
import com.song.game.wuxia.bean.attribute.SpellsAttack;
import com.song.game.wuxia.bean.attribute.SpellsCriticalRate;
import com.song.game.wuxia.bean.attribute.SpellsDefence;
import com.song.game.wuxia.bean.condition.Condition;
import com.song.game.wuxia.bean.equipment.Equipment;
