package com.song.game.soaring.utils
...
object DamageUtil {
    ...
    fun getDamage(attack: Character, defence: Character, wuxue: Wuxue?,
        ...
        Log.i("soaring_attr", "物理伤害值：$physAtt")
        Log.i("soaring_attr", "物理防御值：$phyDef")
        ...
        if (isPhysicalCritical) {
            Log.i("soaring_attr", "物理命中要害")
            phyDam *= 2.5f
        }
        if (isSpellsCritical) {
            speDam *= 2.5f
        }
        Log.i("soaring_attr", "物理实际伤害：$phyDam")
        ...
        Log.i("soaring_attr", "物理实际伤害浮动：$finalRate")
    ...
    fun isPhysicalCritical(attack: Character, defence: Character, wuxue: Wuxue?): Boolean {
        ...
        Log.i("soaring_attr", "物理暴击率：$criticalRate")
