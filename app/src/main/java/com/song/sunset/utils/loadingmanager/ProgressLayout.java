package com.song.sunset.utils.loadingmanager;
...
public class ProgressLayout extends RelativeLayout {
    ...
    private void switchState(String state, Drawable drawable, String errorText, String errorTextContent, String errorButtonText, OnClickListener onClickListener, List<Integer> skipIds) {
        this.state = state;
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            Log.e("setLoadingView: ", (view == loadingStateRelativeLayout) + "");
